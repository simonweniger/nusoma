---
name: instant-db
description: When the user asks for help with InstantDB, or building apps using InstantDB as the backend, use this skill to provide expert guidance and code examples.
metadata:
  author: simonweniger
  version: "0.0.1"
---
