...
const BlockFeature = ({
  ...
  const containerClasses = cn(
    ...
    href && 'cursor-pointer transition-colors hover:bg-neutral-50 dark:hover:bg-neutral-900/50'
  )
...
export function BlockTypes() {
  const features = [
    ...
    },
    {
      title: 'Condition',
      description:
        'Add a condition to the worker to branch the execution path based on a boolean expression.',
    ...
    },
    {
      title: 'Function',
      description:
        'Execute custom JavaScript or TypeScript code within your worker to transform data or implement complex logic.',
    ...
    },
    {
      title: 'Router',
      description:
        'Intelligently direct worker execution to different paths based on input analysis.',
