...
export function Features() {
  const features = [
    ...
    },
    {
      ...
      description: 'Deploy your workers as secure, scalable APIs',
      icon: <IconTerminal2 />,
    },
    {
      title: 'Webhook Integration',
      description: 'Trigger workervia webhooks from external services',
      icon: <IconRouteAltLeft />,
    },
    {
      title: 'Scheduled Execution',
      description: 'Schedule workers to run at specific times or intervals',
      icon: <IconEaseInOut />,
    },
    {
    ...
    },
    {
      ...
      description: 'Debug workers visually with detailed execution logs',
      icon: <IconHelp />,
    },
    {
    ...
    },
    {
      ...
      description: 'Collaborate with team members on worker development',
      icon: <IconHeart />,
    },
  ]
  return (
