...
The Evaluator block allows you to assess the quality of content using customizable evaluation metrics. This is particularly useful for evaluating AI-generated text, ensuring outputs meet specific criteria, and building quality-control mechanisms into your workers.
...
- Building objective feedback loops in your workers
...
5. The Evaluator block formats these scores as structured output for use in your worker
