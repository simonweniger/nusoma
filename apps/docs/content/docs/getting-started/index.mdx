...
description: Build, test, and optimize your agentic workers
---
...
nusoma is a powerful, user-friendly platform for building, testing, and optimizing your agentic workers. This documentation will help you understand how to use the various components of nusoma to create sophisticated agent-based applications.
...
nusoma is built around two primary components:

### Blocks

Blocks are the fundamental building elements of your workers. Each block serves a specific purpose:
...
<Files>
  ...
  <File
    ...
    annotation="Add conditional branching to your workers"
  />
  <File
    name="Function Block"
  ...
  <File
    ...
    annotation="Direct worker execution based on input analysis"
  />
</Files>
...
<Steps>
  <Step title="Create a new worker">
    Start by creating a new worker in the nusoma dashboard.
  </Step>
  ...
  <Step title="Test your worker">Run your worker with test inputs to verify its behavior.</Step>
</Steps>
