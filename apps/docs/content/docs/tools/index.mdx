---
title: Tools
description: Powerful tools to enhance your agentic workers
---
...
Tools are powerful components in nusoma that allow your workers to interact with external services, process data, and perform specialized tasks. They extend the capabilities of your agents and workers by providing access to various APIs and services.
...
There are two primary ways to use tools in your nusoma workers:
...
nusoma provides a diverse collection of tools for various purposes, including:
...
Tools typically return structured data that can be processed by subsequent blocks in your worker. The format of this data varies depending on the tool and operation but generally includes:
