...
The File Parser tool provides a powerful way to extract and process content from various file formats, making it easy to incorporate document data into your agent workers. This tool supports multiple file formats and can handle files up to 200MB in size.
