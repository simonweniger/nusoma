...
description: Learn how connections work in nusoma
---
...
Connections are the pathways that allow data to flow between blocks in your workerWhen you connect two blocks in nusoma, you're establishing a data flow relationship that defines how information passes from one block to another.
...
Connections are visually represented in the workerditor:
...
3. **Worker Logic**: Connections must make logical sense in the context of your worker
