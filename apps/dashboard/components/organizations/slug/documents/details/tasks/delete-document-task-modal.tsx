...
import { deleteDocumentTask } from '~/actions/documents/delete-document-task';
...
export type DeleteDocumentTaskModalProps = NiceModalHocProps & {
  task: DocumentTaskDto;
};

export const DeleteDocumentTaskModal =
  NiceModal.create<DeleteDocumentTaskModalProps>(({ task }) => {
    ...
    const onSubmit: SubmitHandler<DeleteDocumentSchema> = async (values) => {
      ...
      const result = await deleteDocumentTask(values);
