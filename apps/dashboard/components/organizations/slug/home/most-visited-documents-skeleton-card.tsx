...
export type MostVisitedDocumentsSkeletonCardProps = CardProps;

export function MostVisitedDocumentsSkeletonCard(
  props: MostVisitedDocumentsSkeletonCardProps
): React.JSX.Element {
  return (
    <Card {...props}>
