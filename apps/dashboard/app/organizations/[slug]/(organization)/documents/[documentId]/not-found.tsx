...
export const metadata: Metadata = {
  title: createTitle('Document not found')
};

export default function DocumentNotFoundPage(): React.JSX.Element {
  ...
  return (
    <Page>
      ...
      <PageBody>
        <EmptyText className="p-6">Document was not found.</EmptyText>
      </PageBody>
    </Page>
  );
}
