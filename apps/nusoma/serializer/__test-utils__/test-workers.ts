 ...
 * sample worker states with different configurations.
 */
import type { Edge } from '@xyflow/react'
import type { BlockState, Loop } from '@/stores/workers/worker/types'
...
/**
 * Create a minimal worker with just a starter and one block
 */
export function createMinimalWorkerState(): WorkerStateFixture {
...
/**
 * Create a worker with condition blocks
 */
export function createConditionalWorkerState(): WorkerStateFixture {
  const blocks: Record<string, BlockState> = {
    starter: {
      id: 'starter',
      type: 'starter',
...
/**
 * Create a worker with a loop
 */
export function createLoopWorkerState(): WorkerStateFixture {
  const blocks: Record<string, BlockState> = {
    starter: {
      id: 'starter',
      type: 'starter',
...
/**
 * Create a worker with multiple block types
 */
export function createComplexWorkerState(): WorkerStateFixture {
  const blocks: Record<string, BlockState> = {
    starter: {
      id: 'starter',
      type: 'starter',
...
/**
 * Create a worker with agent blocks that have custom tools
 */
export function createAgentWithToolsWorkerState(): WorkerStateFixture {
  const blocks: Record<string, BlockState> = {
    starter: {
      id: 'starter',
      type: 'starter',
...
/**
 * Create a worker state with an invalid block type for error testing
 */
export function createInvalidWorkerState(): WorkerStateFixture {
...
/**
 * Create a serialized worker with invalid metadata for error testing
 */
export function createInvalidSerializedWorker() {
  return {
    version: '1.0',
    blocks: [
      {
...
/**
 * Create a serialized worker with missing metadata for error testing
 */
export function createMissingMetadataWorker() {
  return {
    version: '1.0',
    blocks: [
      {
