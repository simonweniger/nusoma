 ...
 * @returns The domain with port if applicable (e.g., 'localhost:3000' or 'nusoma.app')
 */
export function getBaseDomain(): string {
  try {
    ...
    try {
      ...
      const isProd = process.env.NODE_ENV === 'production'
      return isProd ? 'nusoma.app' : 'localhost:3000'
    }
  }
}
 ...
 * @returns The email domain (e.g., 'nusoma.app' instead of 'www.nusoma.app')
 */
