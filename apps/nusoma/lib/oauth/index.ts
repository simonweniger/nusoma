  ...
  google: {
    ...
    services: {
      gmail: {
        id: 'gmail',
        name: 'Gmail',
        description: 'Automate email workers and enhance communication efficiency.',
      ...
      'google-drive': {
        id: 'google-drive',
        name: 'Google Drive',
        description: 'Streamline file organization and document workers.',
  ...
  github: {
    ...
    services: {
      github: {
        ...
        scopes: ['repo', 'user:email', 'read:user', 'worker'],
      },
    },
