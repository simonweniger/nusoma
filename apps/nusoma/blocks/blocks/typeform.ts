import { TypeformIcon } from '@nusoma/design-system/components/icons'
...
export const TypeformBlock: BlockConfig<TypeformResponse> = {
  ...
  longDescription:
    'Access and retrieve responses from your Typeform forms. Integrate form submissions data into your worker for analysis, storage, or processing.',
  docsLink: 'https://docs.nusoma.app/tools/typeform',
  category: 'tools',
