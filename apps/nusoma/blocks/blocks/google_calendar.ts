import { GoogleCalendarIcon } from '@nusoma/design-system/components/icons'
import type {
...
export const GoogleCalendarBlock: BlockConfig<GoogleCalendarResponse> = {
  ...
  longDescription:
    "Integrate Google Calendar functionality to create, read, update, and list calendar events within your worker. Automate scheduling, check availability, and manage events using OAuth authentication. Email invitations are sent asynchronously and delivery depends on recipients' Google Calendar settings.",
  docsLink: 'https://docs.nusoma.app/tools/google-calendar',
  category: 'tools',
  bgColor: '#E0E0E0',
