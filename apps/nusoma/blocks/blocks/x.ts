import { xIcon } from '@nusoma/design-system/components/icons'
...
export const XBlock: BlockConfig<XResponse> = {
  ...
  longDescription:
    'Connect with X to post tweets, read content, search for information, and access user profiles. Integrate social media capabilities into your worker with comprehensive X platform access.',
  docsLink: 'https://docs.nusoma.app/tools/x',
  category: 'tools',
