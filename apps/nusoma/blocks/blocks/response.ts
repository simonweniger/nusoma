import { ResponseIcon } from '@nusoma/design-system/components/icons'
...
export const ResponseBlock: BlockConfig<ResponseBlockOutput> = {
  ...
  longDescription:
    "Transform your worker's variables into a structured HTTP response for API calls. Define response data, status code, and headers. This is the final block in a worker and cannot have further connections.",
  docsLink: 'https://docs.nusoma.app/blocks/response',
  category: 'blocks',
  bgColor: '#2F55FF',
  icon: ResponseIcon,
  subBlocks: [
    ...
    },
    {
      ...
      description:
        'Define the structure of your response data. Use <variable.name> in field names to reference worker variables.',
    },
    {
      id: 'data',
      title: 'Response Data',
      ...
      description:
        'Data that will be sent as the response body on API calls. Use <variable.name> to reference worker variables.',
    },
    {
      id: 'status',
      title: 'Status Code',
