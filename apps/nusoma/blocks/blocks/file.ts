import { DocumentIcon } from '@nusoma/design-system/components/icons'
...
export const FileBlock: BlockConfig<FileParserOutput> = {
  ...
  longDescription: `Upload and extract contents from structured file formats including PDFs, CSV spreadsheets, and Word documents (DOCX). ${shouldEnableURLInput
  ...
  docsLink: 'https://docs.nusoma.app/tools/file',
  category: 'tools',
  bgColor: '#40916C',
  icon: DocumentIcon,
  subBlocks: [
