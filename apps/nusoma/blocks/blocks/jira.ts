import { JiraIcon } from '@nusoma/design-system/components/icons'
import type {
...
export const JiraBlock: BlockConfig<JiraResponse> = {
  ...
  longDescription:
    'Connect to Jira workspaces to read, write, and update issues. Access content, metadata, and integrate Jira documentation into your workers.',
  docsLink: 'https://docs.nusoma.app/tools/jira',
  category: 'tools',
  bgColor: '#E0E0E0',
  icon: JiraIcon,
  subBlocks: [
    ...
    },
    {
      ...
      type: 'short-input',
      layout: 'full',
      placeholder: 'Enter Jira domain (e.g., nusomalassian.net)',
    },
    {
      id: 'credential',
      title: 'Jira Account',
