import { OutlookIcon } from '@nusoma/design-system/components/icons'
import type {
...
> = {
  ...
  longDescription:
    'Integrate Outlook functionality to read, draft, andsend email messages within your worker. Automate email communications and process email content using OAuth authentication.',
  docsLink: 'https://docs.nusoma.app/tools/outlook',
  category: 'tools',
  bgColor: '#E0E0E0',
  icon: OutlookIcon,
  subBlocks: [
