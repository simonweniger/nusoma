...
export const StarterBlock: BlockConfig<StarterBlockOutput> = {
  ...
  longDescription:
    'Initiate your worker manually, on a schedule, or via webhook triggers. Configure flexible execution patterns with customizable timing options and webhook security.',
  category: 'blocks',
  bgColor: '#2FB3FF',
  icon: StartIcon,
  subBlocks: [
    ...
    //Structured Input format - visible if manual run is selected
    {
      ...
      type: 'input-format',
      layout: 'full',
      condition: { field: 'startWorker', value: 'manual' },
    },
    // Webhook configuration
    {
      ...
      value: () => 'generic',
      condition: { field: 'startWorker', value: 'webhook' },
    },
    {
      id: 'webhookConfig',
    ...
    // Schedule configuration status display
    {
      ...
      layout: 'full',
      condition: { field: 'startWorker', value: 'schedule' },
    },
