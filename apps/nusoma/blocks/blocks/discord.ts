import { DiscordIcon } from '@nusoma/design-system/components/icons'
...
export const DiscordBlock: BlockConfig<DiscordResponse> = {
  ...
  longDescription:
    'Connect to Discord to send messages, manage channels, and interact with servers. Automate notifications, community management, and integrate Discord into your workers.',
  category: 'tools',
  bgColor: '#E0E0E0',
  icon: DiscordIcon,
  subBlocks: [
    ...
    },
    {
      ...
      condition: {
        field: 'operation',
        value: ['discord_send_message', 'discord_get_messages'],
      },
    },
    {
      id: 'userId',
