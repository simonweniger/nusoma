import { ConfluenceIcon } from '@nusoma/design-system/components/icons'
...
export const ConfluenceBlock: BlockConfig<ConfluenceResponse> = {
  ...
  longDescription:
    'Connect to Confluence workspaces to retrieve and search documentation. Access page content, metadata, and integrate Confluence documentation into your workers.',
  docsLink: 'https://docs.nusoma.app/tools/confluence',
  category: 'tools',
  bgColor: '#E0E0E0',
  icon: ConfluenceIcon,
  subBlocks: [
    ...
    },
    {
      ...
      type: 'short-input',
      layout: 'full',
      placeholder: 'Enter Confluence domain (e.g., nusomalassian.net)',
    },
    {
      id: 'credential',
