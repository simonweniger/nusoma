import { BrainIcon } from '@nusoma/design-system/components/icons'
...
export const MemoryBlock: BlockConfig = {
  ...
  longDescription:
    'Create persistent storage for data that needs to be accessed across multiple worker steps. Store and retrieve information throughout your worker execution to maintain context and state.',
  bgColor: '#F64F9E',
  icon: BrainIcon,
  category: 'blocks',
  docsLink: 'https://docs.nusoma.app/tools/memory',
  tools: {
