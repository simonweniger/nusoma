import { GithubIcon } from '@nusoma/design-system/components/icons'
import type {
...
export const GitHubBlock: BlockConfig<GitHubResponse> = {
  ...
  longDescription:
    'Access GitHub repositories, pull requests, and comments through the GitHub API. Automate code reviews, PR management, and repository interactions within your worker.',
  docsLink: 'https://docs.nusoma.app/tools/github',
  category: 'tools',
  bgColor: '#181C1E',
  icon: GithubIcon,
  subBlocks: [
