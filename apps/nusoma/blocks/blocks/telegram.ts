import { TelegramIcon } from '@nusoma/design-system/components/icons'
...
export const TelegramBlock: BlockConfig<TelegramMessageResponse> = {
  ...
  longDescription:
    'Send messages to any Telegram channel using your Bot API key. Integrate automated notifications and alerts into your worker to keep your team informed.',
  docsLink: 'https://docs.nusoma.app/tools/telegram',
  category: 'tools',
  bgColor: '#E0E0E0',
  icon: TelegramIcon,
  subBlocks: [
...
2. Send any message to the channel (e.g. "I love nusoma")
