import { GmailIcon } from '@nusoma/design-system/components/icons'
...
export const GmailBlock: BlockConfig<GmailToolResponse> = {
  ...
  longDescription:
    'Integrate Gmail functionality to send email messages within your worker. Automate email communications and process email content using OAuth authentication.',
  docsLink: 'https://docs.nusoma.app/tools/gmail',
  category: 'tools',
  bgColor: '#E0E0E0',
  icon: GmailIcon,
  subBlocks: [
