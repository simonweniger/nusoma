...
import { ToolbarBlock } from '@/app/(dashboard)/workspace/[workspaceId]/workers/[workerId]/components/toolbar/components/toolbar-block/toolbar-block'
import LoopToolbarItem from '@/app/(dashboard)/workspace/[workspaceId]/workers/[workerId]/components/toolbar/components/toolbar-loop-block/toolbar-loop-block'
import ParallelToolbarItem from '@/app/(dashboard)/workspace/[workspaceId]/workers/[workerId]/components/toolbar/components/toolbar-parallel-block/toolbar-parallel-block'
import { ToolbarTabs } from '@/app/(dashboard)/workspace/[workspaceId]/workers/[workerId]/components/toolbar/components/toolbar-tabs/toolbar-tabs'
...
export function Toolbar({ scrollToSection, activeSection }: ToolbarProps) {
  ...
  // Get the workspace ID from the worker registry
  const activeWorkspaceId = useWorkerRegistry((state) => state.activeWorkspaceId)
  const currentWorker = useWorkerRegistry((state) => (workerId ? state.workers[workerId] : null))
  const workspaceId = currentWorker?.workspaceId || activeWorkspaceId
