...
import { CodeBlock } from '@nusoma/design-system/components/ui/code-block'
    ...
    <div className='space-y-4'>
      ...
      >
        <ol className='list-inside list-decimal space-y-1'>
          ...
          <li>Your worker triggers when Discord sends an event to that URL.</li>
        </ol>
      </InstructionsSection>

      <InstructionsSection title='Sending Messages to Discord (Outgoing via this URL)'>
        <p>
          To send messages <i>to</i> Discord using the nusoma Webhook URL (above), make a POST
      ...
      <Alert>
        ...
        <AlertDescription>
          The nusoma Webhook URL allows sending messages <i>to</i> Discord. Treat it like a
