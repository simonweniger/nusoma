...
export function LoopBadges({ nodeId, data }: LoopBadgesProps) {
  ...
  const updateLoopType = useWorkerStore((state) => state.updateLoopType)
  const updateLoopCount = useWorkerStore((state) => state.updateLoopCount)
  const updateLoopCollection = useWorkerStore((state) => state.updateLoopCollection)
