...
export function ShortInput({
  ...
  const _validatePropValue = (value: any): string => {
  ...
  // Use preview value when provided, prop value if available, otherwise store value
  const value =
  ...
  const handleDragOver = (e: React.DragEvent<HTMLInputElement>) => {
    if (config?.connectionDroppable === false) {
      return
    }
    e.preventDefault()
  }
