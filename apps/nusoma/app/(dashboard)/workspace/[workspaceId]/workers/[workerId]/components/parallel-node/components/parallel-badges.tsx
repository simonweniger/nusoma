...
export function ParallelBadges({ nodeId, data }: ParallelBadgesProps) {
  ...
  // Get store methods
  const updateParallelCount = useWorkerStore((state) => state.updateParallelCount)
  const updateParallelCollection = useWorkerStore((state) => state.updateParallelCollection)
