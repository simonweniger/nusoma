...
import { GmailIcon, OutlookIcon } from '@nusoma/design-system/components/icons'
...
export function FolderSelector({
  ...
  const [_isLoadingSelectedFolder, setIsLoadingSelectedFolder] = useState(false)
  ...
  const fetchFolderById = useCallback(
    async (folderId: string) => {
      if (!selectedCredentialId || !folderId || provider === 'outlook') {
        return null
      }
