...
vi.mock('@/stores/workers/worker/store', () => ({
...
// Mock UI components
vi.mock('@nusoma/design-system/components/ui/button', () => ({
  Button: ({ children, onClick, ...props }: any) => ({ children, onClick, ...props }),
}))

vi.mock('@nusoma/design-system/components/ui/card', () => ({
  Card: ({ children, ...props }: any) => ({ children, ...props }),
}))

vi.mock('@nusoma/design-system/components/icons', () => ({
  StartIcon: ({ className }: any) => ({ className }),
}))

vi.mock('@nusoma/design-system/lib/utils', () => ({
...
describe('ParallelNodeComponent', () => {
  ...
  beforeEach(() => {
    vi.clearAllMocks()
      ...
      // Mock useWorkerStore
      ; (useWorkerStore as any).mockImplementation((selector: any) => {
        const state = {
  ...
  describe('Store Integration', () => {
    it('should integrate with worker store', () => {
      // Test that the component uses the store correctly
      expect(useWorkerStore).toBeDefined()
