...
import { JSONView } from '../../../../../../../panel/components/console/components/json-view/json-view'
...
const TOOLTIPS = {
  ...
  markAsRead: 'Emails will be marked as read after being processed by your worker.',
