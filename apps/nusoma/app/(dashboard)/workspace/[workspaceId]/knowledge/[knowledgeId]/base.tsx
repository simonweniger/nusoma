...
import { ProcessingStatus } from '@nusoma/database/schema'
import { SearchInput } from '@nusoma/design-system/components/search-input'
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
import { ActionBar } from '@/app/(dashboard)/workspace/[workspaceId]/knowledge/[knowledgeId]/components/action-bar/action-bar'
...
export function KnowledgeBase({
  ...
  const checkForDeadProcesses = async () => {
    ...
    const staleDocuments = documents.filter((doc) => {
      if (doc.processingStatus !== ProcessingStatus.PROCESSING || !doc.processingStartedAt) {
        return false
      }
  ...
  const handleDocumentClick = (docId: string) => {
    ...
    router.push(`/worker/knowledge/${id}/${docId}?${params.toString()}`)
  }
            ...
            <div className='px-6 pb-6'>
              ...
              <div className='mb-4 flex items-center justify-between pt-1'>
                ...
                <div className='flex items-center gap-3'>
                  ...
                  <Button onClick={handleAddDocuments} disabled={isUploading}>
