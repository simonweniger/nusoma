...
export function Document({
  ...
  const breadcrumbs = [
    { label: 'Knowledge', href: '/worker/knowledge' },
    {
      label: effectiveKnowledgeBaseName,
      href: `/worker/knowledge/${knowledgeBaseId}`,
    },
            ...
            <div className='px-6 pb-6'>
              ...
              <div className='mb-4 flex items-center justify-between pt-1'>
                <div className='relative max-w-md'>
                  <div className='relative flex items-center'>
                    ...
                    <input
                      ...
                      disabled={document?.processingStatus !== ProcessingStatus.COMPLETED}
                    ...
                    />
                    {searchQuery && document?.processingStatus === ProcessingStatus.COMPLETED && (
                      <button
                ...
                <Button
                  ...
                  disabled={document?.processingStatus === ProcessingStatus.FAILED}
                  size='sm'
              ...
              <div className='flex flex-1 flex-col overflow-hidden'>
                ...
                {/* Pagination Controls */}
                {document?.processingStatus === ProcessingStatus.COMPLETED && totalPages > 1 && (
