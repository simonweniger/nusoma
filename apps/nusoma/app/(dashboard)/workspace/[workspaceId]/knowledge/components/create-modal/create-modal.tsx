...
export function CreateModal({ open, onOpenChange, onKnowledgeBaseCreated }: CreateModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className='flex h-[74vh] flex-col gap-0 overflow-hidden p-0 sm:max-w-[600px]'>
            ...
            >
              <div className='flex min-h-full flex-col py-4'>
                {submitStatus && submitStatus.type === 'success' ? (
                  <Alert className='mb-6 border-border bg-green-50 dark:border-green-900 dark:bg-green-950/30'>
