...
export default function Invite() {
    ...
    async function fetchInvitationDetails() {
      ...
      try {
        ...
        try {
          ...
          logger.error('Error fetching organization invitation:', err)
  ...
  // Show login//auth/sign-up prompt if not logged in
      ...
      <div className='flex min-h-screen flex-col items-center justify-center bg-muted/40 p-4'>
        <Card className='w-full max-w-md p-6'>
          <CardHeader className='px-0 pt-0 text-center'>
            ...
            <CardDescription>
              {isNewUser
                ? 'Create an account to join this workspace on nusoma'
            ...
            {isNewUser ? (
              <>
                <Button
                  className='w-full'
                  onClick={() =>
                    router.push(`//auth/sign-up?callbackUrl=${callbackUrl}&invite_flow=true`)
                  }
                >
                  Create an account
                </Button>
                <Button
                  ...
                  className='w-full'
                  onClick={() =>
                    router.push(`/auth/sign-in?callbackUrl=${callbackUrl}&invite_flow=true`)
                  }
                >
              ...
              <>
                ...
                <Button
                  ...
                  onClick={() =>
                    router.push(
                      `//auth/sign-up?callbackUrl=${callbackUrl}&invite_flow=true&new=true`
                    )
                  }
                >
                  Create an account
