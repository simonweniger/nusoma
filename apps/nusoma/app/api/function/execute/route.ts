 ...
 * @param envVars - Environment variables from the worker
...
function resolveCodeVariables(
  ...
  for (const match of envVarMatches) {
    ...
    // Priority: 1. Environment variables from worker, 2. Params
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const { code, params = {}, timeout = 5000, envVars = {}, workerId, isCustomTool = false } = body
    ...
    // Resolve variables in the code with worker environment variables
