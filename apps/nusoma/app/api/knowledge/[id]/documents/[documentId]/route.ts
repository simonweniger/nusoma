...
import { document, embedding, ProcessingStatus } from '@nusoma/database/schema'
  ...
  try {
    ...
    try {
      ...
      if (validatedData.markFailedDueToTimeout) {
        ...
        updateData.processingStatus = ProcessingStatus.FAILED
        ...
        if (validatedData.processingStatus !== undefined)
          updateData.processingStatus = validatedData.processingStatus as ProcessingStatus
