...
describe('OAuth Token API Routes', () => {
  ...
  describe('POST handler', () => {
    ...
    it('should handle workerId for server-side authentication', async () => {
      mockGetUserId.mockResolvedValueOnce('worker-owner-id')
      mockGetCredential.mockResolvedValueOnce({
        id: 'credential-id',
        accessToken: 'test-token',
        refreshToken: 'refresh-token',
      ...
      expect(mockGetUserId).toHaveBeenCalledWith(mockRequestId, 'worker-id')
