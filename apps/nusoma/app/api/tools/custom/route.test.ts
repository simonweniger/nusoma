...
describe('Custom Tools API Routes', () => {
  ...
  describe('GET /api/tools/custom', () => {
    ...
    it('should handle workerId parameter', async () => {
      // Create mock request with workerId parameter
      const req = new NextRequest('http://localhost:3000/api/tools/custom?workerId=worker-123')
      ...
      expect(getUserId).toHaveBeenCalledWith(expect.any(String), 'worker-123')
