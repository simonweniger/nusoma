/**
 * Integration tests for scheduled worker execution API route
 *
...
describe('Scheduled Worker Execution API Route', () => {
  beforeEach(() => {
    vi.resetModules()
  ...
  it('should execute scheduled workers successfully', async () => {
