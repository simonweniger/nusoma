...
import { webhook } from '@nusoma/database/schema'
    ...
    switch (provider) {
      ...
      case 'telegram': {
        ...
        return NextResponse.json({
          ...
          message: success
            ? 'Telegram webhook appears to be working. Any message sent to your bot will trigger the worker.'
              ...
              changedTablesById: {
                [tableId]: {
                  ...
                  changedRecordsById: {
                    recSAMPLEID1: {
                      current: {
                        cellValuesByFieldId: { fldSAMPLEID: 'New Value' },
                      },
                      previous: {
                        cellValuesByFieldId: { fldSAMPLEID: 'Old Value' },
                      },
                    },
                  },
                  changedFieldsById: {},
