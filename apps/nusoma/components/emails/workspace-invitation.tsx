  ...
  return (
    <Html>
      ...
      <Body style={baseStyles.main}>
        <Preview>You've been invited to join the "{workspaceName}" workspace on nusoma!</Preview>
        <Container style={baseStyles.container}>
          ...
          <Section style={baseStyles.content}>
            ...
            <Text style={baseStyles.paragraph}>
              {inviterName} has invited you to join the "{workspaceName}" workspace on nusoma!
            </Text>
            <Text style={baseStyles.paragraph}>
              nusoma is a powerful platform for building, testing, and optimizing AI workers. Join
