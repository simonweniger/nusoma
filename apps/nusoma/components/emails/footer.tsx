...
export const EmailFooter = ({
  baseUrl = env.NEXT_PUBLIC_APP_URL || 'https://nusoma.app',
  unsubscribe,
}: EmailFooterProps) => {
  return (
    <Container>
        ...
        <table style={{ width: '100%' }}>
              ...
              <table cellPadding={0} cellSpacing={0} style={{ border: 0 }}>
                <tr>
                  <td align='center' style={{ padding: '0 8px' }}>
                    <Link href='https://x.com/nusoma.app' rel='noopener noreferrer'>
                  ...
                  <td align='center' style={{ padding: '0 8px' }}>
                    <Link href='https://github.com/simonweniger/nusoma' rel='noopener noreferrer'>
                      <Img
          ...
          <tr>
            <td align='center' style={{ paddingTop: '12px' }}>
              ...
              >
                © {new Date().getFullYear()} nusoma, All Rights Reserved
                <br />
                If you have any questions, please contact us at{' '}
                <a
                  href='mailto:help@nusoma.app'
                  style={{
                      ...
                      <a
                        href={
                          unsubscribe?.unsubscribeToken && unsubscribe?.email
                            ...
                            : 'mailto:help@nusoma.app?subject=Unsubscribe%20Request&body=Please%20unsubscribe%20me%20from%20all%20emails.'
                        }
                        style={{
                          color: '#706a7b !important',
                          textDecoration: 'underline',
