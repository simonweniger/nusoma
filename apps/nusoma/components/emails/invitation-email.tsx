...
const baseUrl = env.NEXT_PUBLIC_APP_URL || 'https://nusoma.app'
  ...
  return (
    <Html>
      ...
      <Body style={baseStyles.main}>
        <Preview>You've been invited to join {organizationName} on nusoma</Preview>
        <Container style={baseStyles.container}>
          <Section style={{ padding: '30px 0', textAlign: 'center' }}>
            <Row>
              <Column style={{ textAlign: 'center' }}>
                <Img
                  src={`${baseUrl}/static/nusoma.png`}
                  width='114'
                  alt='nusoma'
                  style={{
                    margin: '0 auto',
          ...
          <Section style={baseStyles.content}>
            ...
            <Text style={baseStyles.paragraph}>
              ...
              <strong>{organizationName}</strong> on nusoma. nusoma is a powerful, user-friendly
              platform for building, testing, and optimizing agentic workers.
            </Text>
            ...
            >
              ...
              an invitation to join {organizationName} on nusoma.
            </Text>
          </Section>
        </Container>
