# Contributing to nusoma

Thanks for your interest in contributing! nusoma is a desktop overlay for Claude Code, and we welcome bug reports, feature ideas, and pull requests.
...
2. Fork and clone the repo:
   ...
   ```bash
   git clone https://github.com/<your-username>/nusoma-cc.git
   cd nusoma-cc
   ```
...
- Set `CLUI_DEBUG=1` to enable verbose main-process logging to `~/.nusoma-debug.log`.
