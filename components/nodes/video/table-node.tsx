...
import { getVideoModelFields } from '@/lib/model-fields';
import { useProject } from '@/providers/project';
import type { VideoNodeProps } from '.';

type VideoTableNodeProps = VideoNodeProps & {
  title: string;
};

export const VideoTableNode = ({
  data,
  id,
  type,
  title,
  ...
  const modelFields = useMemo(() => {
    return getVideoModelFields(data.model || data.falEndpoint);
  ...
  const handleGenerate = useCallback(async () => {
    ...
    try {
      ...
      const prompt = data.instructions || 'Generate a video';
