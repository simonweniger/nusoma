...
- TIPTAP_COLLAB_TOKEN - JWT token for accessing Collaboration services (do not use in production)
- TIPTAP_AI_APP_ID - Your AI App ID
- TIPTAP_AI_TOKEN - JWT token for accessing AI services (do not use in production)
Follow this guide: https://tiptap.dev/docs/ui-components/templates/nusoma-editor`)
  } else {
    console.warn(
      "You are using the example JWT token provided in the Tiptap Cloud dashboard. This is only for local development and should not be used in production. In production, implement an API endpoint that generates a new JWT token in the server, and call that API endpoint from the fetchCollabToken function. More info in the docs: https://tiptap.dev/docs/ui-components/templates/nusoma-editor"
    )
  }
...
Follow this guide: https://tiptap.dev/docs/ui-components/templates/nusoma-editor`)
    ...
    console.warn(
      "You are using the example JWT token provided in the Tiptap Cloud dashboard. This is only for local development and should not be used in production. In production, implement an API endpoint that generates a new JWT token in the server, and call that API endpoint from the fetchAiToken function. More info in the docs: https://tiptap.dev/docs/ui-components/templates/nusoma-editor"
    )
  }
