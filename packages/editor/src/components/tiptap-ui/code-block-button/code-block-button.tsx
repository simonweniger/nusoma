...
// --- Tiptap UI ---
import type { UseCodeBlockConfig } from '@workspace/editor/components/tiptap-ui/code-block-button';
import {
  CODE_BLOCK_SHORTCUT_KEY,
  useCodeBlock
} from '@workspace/editor/components/tiptap-ui/code-block-button';
// --- Hooks ---
