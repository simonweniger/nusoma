...
// --- Utils ---
import { chunkArray } from '@workspace/editor/lib/tiptap-advanced-utils';

// --- Styles ---
import '@workspace/editor/components/tiptap-ui/color-text-popover/color-text-popover.scss';
