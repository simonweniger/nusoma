...
import { createTableDragImage } from '@workspace/editor/components/tiptap-node/table-node/extensions/table-handle/helpers/create-image';
import {
  clamp,
  domCellAround,
...
import { isValidPosition } from '@workspace/editor/lib/tiptap-utils';
