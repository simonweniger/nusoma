  ...
  return (
    ...
    >
      <Button
        ...
        variant="secondary"
        size="icon"
        className="m-0 flex w-[17px] h-[17px] items-center justify-center rounded-none"
...
const InputNumber = ({
  ...
  return (
    ...
    >
      ...
      />
      {unit && (
        <div className="col-start-2 row-start-1 flex items-center justify-center pl-1 pr-3 text-sm text-fg-muted">
          {unit}
        </div>
      )}
      <InputSpinner
