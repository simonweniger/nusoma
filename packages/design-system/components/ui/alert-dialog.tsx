...
export type AlertDialogElement = React.ComponentRef<typeof AlertDialogPrimitive.Root>
...
export type AlertDialogTriggerElement = React.ComponentRef<typeof AlertDialogPrimitive.Trigger>
...
export type AlertDialogPortalElement = React.ComponentRef<typeof AlertDialogPrimitive.Portal>
...
export type AlertDialogOverlayElement = React.ComponentRef<typeof AlertDialogPrimitive.Overlay>
export type AlertDialogOverlayProps = React.ComponentPropsWithoutRef<
  typeof AlertDialogPrimitive.Overlay
>
function AlertDialogOverlay({ className, ...props }: AlertDialogOverlayProps): React.JSX.Element {
  return (
...
export type AlertDialogContentElement = React.ComponentRef<typeof AlertDialogPrimitive.Content>
...
export type AlertDialogTitleElement = React.ComponentRef<typeof AlertDialogPrimitive.Title>
export type AlertDialogTitleProps = React.ComponentPropsWithoutRef<
  typeof AlertDialogPrimitive.Title
>
function AlertDialogTitle({ className, ...props }: AlertDialogTitleProps): React.JSX.Element {
  return (
...
export type AlertDialogActionElement = React.ComponentRef<typeof AlertDialogPrimitive.Action>
export type AlertDialogActionProps = React.ComponentPropsWithoutRef<
  typeof AlertDialogPrimitive.Action
>
function AlertDialogAction({ className, ...props }: AlertDialogActionProps): React.JSX.Element {
  return <AlertDialogPrimitive.Action className={cn(buttonVariants(), className)} {...props} />
}

export type AlertDialogCancelElement = React.ComponentRef<typeof AlertDialogPrimitive.Cancel>
export type AlertDialogCancelProps = React.ComponentPropsWithoutRef<
  typeof AlertDialogPrimitive.Cancel
>
function AlertDialogCancel({ className, ...props }: AlertDialogCancelProps): React.JSX.Element {
  return (
