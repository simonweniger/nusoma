...
import { Callout } from "@/components/landing/blog/callout";
...
const components = {
  ...
  TabsTrigger: ({
    ...
    <UnderlinedTabsTrigger className={cn("", className)} {...props} />
  ),
  TabsContent: ({
    className,
    ...props
  }: React.ComponentProps<typeof UnderlinedTabsContent>) => (
    <UnderlinedTabsContent className={cn("p-4", className)} {...props} />
  ),
