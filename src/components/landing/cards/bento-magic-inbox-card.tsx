...
function OutlookCalendar(
  ...
  return (
    ...
    >
      ...
      />
      <path fill="#28a8ea" d="M110 49H82v26l28 26h28V75z" />
      <path
        fill="#0364b8"
      ...
      />
      <path fill="#14447d" d="M54 101h28v26H54z" />
      <path fill="#0078d4" d="M110 101h28v26h-28z" />
      <path fill="#50d9ff" d="M110 49h28v26h-28z" />
      <path fill="#0078d4" d="M53 49h29v26H53zm29 26h28v26H82z" />
      <path
        fill="#0358a7"
              ...
              {DATA_MAGIC_INBOX.map(({ icon: Icon }, index) => (
                ...
                >
                  <div className="size-10 rounded-full border-2 border-background ring-1 ring-border/80">
                    <Icon width={36} height={36} className="rounded-full" />
                  </div>
                </div>
              ))}
            </div>
