/**
 * NUSOMA Design Tokens — Dual theme (dark + light)
...
/** Convert camelCase token name to --nusoma-kebab-case CSS custom property */
...
function syncTokensToCss(tokens: ColorPalette): void {
  ...
  for (const [key, value] of Object.entries(tokens)) {
    style.setProperty(`--nusoma-${camelToKebab(key)}`, value)
  }
}
...
const SETTINGS_KEY = 'nusoma-settings'
