...
export const ForgotPasswordEmailTemplate = ({
  ...
  <Html>
    <Head />
    <Preview>Reset your password for nusoma</Preview>
    <EmailLayout>
      ...
      <Text className="text-left text-[#525f7f] text-base leading-6">
        Click the button below to securely reset your password for your nusoma
        account.
      </Text>
      <Link
...
ForgotPasswordEmailTemplate.PreviewProps = {
  magicLink: 'https://www.nusoma.ai/reset-password',
  email: 'test@test.com',
